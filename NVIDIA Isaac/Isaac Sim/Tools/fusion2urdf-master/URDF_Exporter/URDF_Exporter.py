...
def run(context):
    ...
    try:
        ...
        # Copy the main xacro to a plain .urdf for Isaac Sim / standalone use
        xacro_path = save_dir + '/urdf/' + robot_name + '.xacro'
        urdf_path  = save_dir + '/urdf/' + robot_name + '.urdf'
        shutil.copy(xacro_path, urdf_path)
